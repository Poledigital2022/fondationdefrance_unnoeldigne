...
var _webpDetect2 = __webpack_require__(101);

var _webpDetect3 = _interopRequireDefault(_webpDetect2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// please follow Javascript development guidelines in README.md

//polyfills
$(document).ready(function () {
    $('html.no-js').toggleClass('js no-js');

    var _webpDetect = new _webpDetect3.default();
    _webpDetect.webpSupported();
});
...
var isArrayIter = __webpack_require__(44);
var toLength = __webpack_require__(5);
var createProperty = __webpack_require__(45);
var getIterFn = __webpack_require__(46);
...
$export($export.P + $export.F * (__webpack_require__(23) != Object || !__webpack_require__(2)(arrayJoin)), 'Array', {
...
var STRICT = __webpack_require__(2)([].forEach, true);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(16)(Function.call, __webpack_require__(99).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
